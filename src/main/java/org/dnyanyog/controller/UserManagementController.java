...
public class UserManagementController {
  ...
  public Optional<AddUserResponse> addUpdateUser(@RequestBody AddUserRequest userRequest)
      throws Exception {
  ...
  @PostMapping(
      ...
      consumes = {"application/json", "application/xml"},
      produces = {"application/json", "application/xml"})
  public AddUserResponse UpdateUser(
      @RequestBody AddUserRequest userRequest, @PathVariable Long userId) {
